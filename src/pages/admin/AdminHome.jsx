	...
	return (
		<>
			...
			<CustomDialogBox 
						...
						buttonCancel={handleOpenAddDialog}
						title="Add New" 
						buttonCancelLabel="Cancel"
						buttonSubmitLabel={
							!isClicked ? "Save" : (<ButtonLoading label="Saving..." color="green" />)
						}
						  ...
						  <div className="mb-1 flex flex-col ">
						    ...
						    <div className="relative my-4">
						        <textarea
						          ...
						          className="peer h-full min-h-[30px] w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-dark/75 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
						          placeholder=" "
						        ></textarea>

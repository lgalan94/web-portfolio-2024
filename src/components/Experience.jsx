...
const Details = ({ position, company, companyLink, time, address, work }) => {
	...
	return <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between">
		...
		<div>
			<Typography className="capitalize" variant="h3"> {position}&nbsp; <a href={companyLink} target="_blank" className="text-red-300" >@{company}</a> </Typography>
...
const {scrollYProgress} = useScroll(
	...
	return (
		...
		<motion.div 
			...
			className="absolute left-9 top-0 w-[4px] h-full bg-red-800 origin-top" />

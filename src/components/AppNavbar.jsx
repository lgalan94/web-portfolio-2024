  ...
  const navList = (
    <ul className="mt-2 mb-6 lg:mb-0 lg:mt-0 text-sm flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-6">
      ...
      <a 
        href="/resume.pdf"
        download
        className="ml-3 mt-2 lg:mt-0 flex items-center p-2 px-6 rounded-lg text-black/75 text-xs md:text-sm lg:text-md font-medium hover:bg-neutral-50 hover:text-neutral-700 border border-solid border-dark/25 hover:scale-105 hover:border-neutral-800"
